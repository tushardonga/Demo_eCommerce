  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 relative">
      <button
        ...
        className="absolute right-2 top-2 p-1 rounded-full bg-red-500 hover:bg-red-600 text-white transition-colors duration-300 focus:outline-none"
      >
        <DeleteIcon />
      </button>
      <img
      ...
      <div className="px-4 py-3">
        ...
        <div className="bg-gray-100 px-4 py-2 rounded-lg md:flex md: justify-between items-center">
          <div>
